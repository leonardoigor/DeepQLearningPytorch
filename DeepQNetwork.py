...
class DeepQNetwork(nn.Module):
    def __init__(self, lr, input_dims, fcs1_dims, fcs2_dims, n_actions):
        super(DeepQNetwork, self).__init__()
        self.input_dims = input_dims
        self.fc1 = nn.Linear(*input_dims, fcs1_dims)
        self.fc2 = nn.Linear(fcs1_dims, fcs2_dims)
        self.fc3 = nn.Linear(fcs2_dims, n_actions)
...
class Agent(object):
    def __init__(self,
        ...
        self.Q_eval = DeepQNetwork(
            lr, n_actions=n_actions, input_dims=input_dims, fcs1_dims=256, fcs2_dims=256)
